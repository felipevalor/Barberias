        ...
        <div className="max-w-6xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-500 mb-1">Balance del Día</p>
                        <h3 className="text-3xl font-black text-gray-900">${flujo?.resumen?.balance || 0}</h3>
                    </div>
                </div>

                {/* Ingresos */}
                <div className="bg-white rounded-2xl shadow-sm border border-green-100 p-6 flex items-center">
                    ...
                    <div>
                        ...
                        <h3 className="text-3xl font-black text-green-600">${flujo?.resumen?.totalIngresos || 0}</h3>
                    </div>
                </div>

                {/* Egresos */}
                <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-6 flex items-center">
                    <div className="p-4 bg-red-100 text-red-600 rounded-xl mr-4">
                        <TrendingDown className="w-8 h-8" />
                    </div>
                    <div>
                        <p className="text-sm font-medium text-gray-500 mb-1">Total Egresos</p>
                        <h3 className="text-3xl font-black text-red-600">${flujo?.resumen?.totalEgresos || 0}</h3>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr key={t.id} className="hover:bg-gray-50 transition">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <div className="text-sm font-bold text-gray-900">{t.descripcion}</div>
                                                    {t.turno?.cliente && (
                                        ...
                                        <td className={`px-6 py-4 whitespace-nowrap text-right text-sm font-bold ${t.tipo === 'INGRESO' ? 'text-green-600' : 'text-red-600'}`}>
