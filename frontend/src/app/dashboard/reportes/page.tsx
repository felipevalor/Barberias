        ...
        <div className="max-w-6xl mx-auto space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">
                        Rendimiento del equipo del <strong className="text-slate-700">{format(dateRange.start, "d 'de' MMMM", { locale: es })}</strong> al <strong className="text-slate-700">{format(dateRange.end, "d 'de' MMMM, yyyy", { locale: es })}</strong>
                    </p>
                </div>
                ...
                <div className="flex space-x-2 bg-gray-100 p-1 rounded-lg">
                    <button
                        ...
                        className="px-3 py-1.5 text-sm font-medium rounded-md hover:bg-white hover:shadow-sm transition text-gray-600"
                    >
                        Mes Anterior
                    </button>
                    <button
                        onClick={setMesActual}
                        className="px-3 py-1.5 text-sm font-medium rounded-md bg-white shadow-sm text-slate-900"
                    >
                        Este Mes
                    </button>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-500">Ingresos Totales (Servicios)</p>
                        <p className="text-3xl font-black text-gray-900">${totalIngresos.toLocaleString()}</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-medium text-gray-500">Servicios Realizados</p>
                        <p className="text-3xl font-black text-gray-900">{totalServicios}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-5 border-b border-gray-100 bg-gray-50/50 flex items-center">
                    ...
                    <h3 className="font-bold text-gray-900">Rendimiento por Barbero</h3>
                </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-slate-200">
                                {rendimiento.map((item, idx) => {
                                    ...
                                    return (
                                        <tr key={item.barberoId} className={idx === 0 ? 'bg-purple-50/30' : ''}>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="ml-3">
                                                        <span className="font-bold text-slate-900">
                                                            {item.nombre}
                                                            {idx === 0 && <span className="ml-2 inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-purple-100 text-purple-800">TOP 1</span>}
                                                        </span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-center">
                                                <div className="flex items-center justify-center">
                                                    <span className="text-sm font-bold text-slate-600 w-12 text-right mr-2">{porcentaje}%</span>
